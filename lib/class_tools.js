...
define(['vendor/f-empower'], function(fn) {
  var clonedeep, delete_key_from_collection, get_from_table, index_of_key_in_collection, map, merge_blueprints, merge_event_tables, merge_mixin, merge_mixin_one, merge_partial_initializers, mix_of, multicall, name_isnt_reserved, to_objects_array, transform_events, union;
