...
define(['vendor/f-empower'], function(fn) {
  var SuperEmitter, a_contains, a_each, a_get, bind, each, first, is_array, is_function, listen, make_action_undefined_exception, map, mutate_list, partial, remove_at, second, to_emitter_row, unlisten_components, vals, _unlisten_component;
